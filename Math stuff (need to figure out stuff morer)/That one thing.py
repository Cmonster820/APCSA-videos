...
class Big10FTC3(Scene):
    def construct(self):
        ...
        t1l = MathTex(r"-1")
        t2l = MathTex(r"3")
        t1l.move_to(tri1.get_center())
        t2l.move_to(tri2.get_center())
        areagroup = VGroup(tri1,tri2)
        labelgroup = VGroup(t1l,t2l)
        box = SurroundingRectangle(explanation1p2,buff=0.1)
        self.play(Create(box),DrawBorderThenFill(areagroup))
        self.play(Write(labelgroup))
        explanation1p3 = MathTex(r"-1",r"+",r"3")
        explanation1p3.move_to(explanation1p2)
        ex3g1 = VGroup(explanation1p3[0],explanation1p3[2])
        self.wait(2)
        self.play(Uncreate(box),Transform(explanation1p2,explanation1p3[1]))
        self.add(explanation1p3[1])
        self.remove(explanation1p2)
        self.wait(0.5)
        self.play(Transform(labelgroup,ex3g1))
        self.add(ex3g1)
        self.remove(labelgroup)
        self.wait(0.5)
        explanation1p4 = MathTex(r"2")
        explanation1p4.move_to(explanation1p3)
        self.play(Transform(explanation1p3,explanation1p4))
        self.play(Transform(explanation1p3,question[1]))
        self.add(question[1])
        self.remove(explanation1p3)
        self.wait(2)
        self.play(Unwrite(question),Uncreate(areagroup))
        newInfo = MathTex(r"h(x)=\int_{-1}^{2x}\!f(t)~dt")
        newInfo.move_to(info)
        self.play(Transform(info,newInfo))
        question = MathTex(r"Find~h'(1)=",r"4")
        question.next_to(graphall,DOWN)
        question.shift([2,0,0])
        self.play(Write(question[0]))
        explanation2p1 = MathTex(r"h(x)=\int_{-1}^{2x}\!f(t)~dt")
        explanation2p1.next_to(question,DOWN)
        self.wait(2)
        self.play(Write(explanation2p1))
        explanation2p2 = MathTex(r"h'(x)=",r"2f(2x)")
        explanation2p2.move_to(explanation2p1)
        self.wait(0.5)
        self.play(Transform(explanation2p1,explanation2p2))
        self.add(explanation2p2)
        self.remove(explanation2p1)
        self.wait(0.5)
        explanation2p3 = MathTex(r"h'(1)=",r"2f(2)")
        explanation2p3.move_to(explanation2p2)
        self.play(Transform(explanation2p2,explanation2p3))
        self.add(explanation2p3)
        self.remove(explanation2p2)
        self.wait(0.5)
        dot = Dot(point=np.coords_to_point(2,2),color=YELLOW)
        box = SurroundingRectangle(explanation2p3[1],buff=0.1)
        self.play(Create(box),Create(dot))
        self.wait(2)
        explanation2p4 = MathTex(r"h'(1)=2(2)")
        explanation2p5 = MathTex(r"h'(1)=4")
        explanation2p4.move_to(explanation2p3)
        explanation2p5.move_to(explanation2p4)
        self.play(Transform(explanation2p3,explanation2p4))
        self.wait(0.5)
        self.play(Transform(explanation2p3,explanation2p5),Uncreate(box),Uncreate(dot))
        self.wait(0.5)
        self.play(Transform(explanation2p3,question[1]))
        self.add(question[1])
        self.remove(explanation2p3)
        self.wait(2)
...
class Big10FTC4(Scene):
    def construct(self):
        ...
        firstline = Line(np.coords_to_point(0,-2),np.coords_to_point(1,0),color=BLUE)
        secondline = Line(np.coords_to_point(1,0),np.coords_to_point(2,6),color=BLUE)
        thirdline = Line(np.coords_to_point(2,6),np.coords_to_point(3,4),color=BLUE)
        label = MathTex(r"g'(x)")
        label.move_to(np.coords_to_point(1,1))
        graph = VGroup(firstline,secondline,thirdline)
        graphstuff = VGroup(np,graph)
        graphall = VGroup(graphstuff,label)
        self.play(Create(np))
        self.play(Create(graph))
        ...
        self.wait(2)
        graphtarget = graphall.copy()
        graphtarget.height=4
        graphtarget.to_corner(UL)
        self.play(Transform(graphall,graphtarget))
        info = MathTex(r"g(0)=2")
        question = MathTex(r"Find~g(3)=",r"9")
        info.next_to(graphall,RIGHT)
        question.next_to(graphall,DOWN)
        question.shift([2,0,0])
        self.play(Write(info),Write(question))
        self.wait(2)
        explanation1p1 = MathTex(r"g(x)=g(0)+\int_{0}^{x}\!g'(x)~dx")
        explanation1p1.next_to(question,DOWN)
        explanation1p2 = MathTex(r"g(3)=2+",r"\int_{0}^{3}\!g'(x)~dx")
        explanation1p2.move_to(explanation1p1)
        self.play(Write(explanation1p1))
        self.wait(0.5)
        self.play(Transform(explanation1p1,explanation1p2))
        ...
        self.remove(explanation1p1)
        self.wait(0.5)
        box = SurroundingRectangle(explanation1p2[1],buff=0.1)
        poly1 = Polygon(np.coords_to_point(0,-2),np.coords_to_point(0,0),np.coords_to_point(1,0),color=YELLOW,fill_opacity=0.5)
        poly2 = Polygon(np.coords_to_point(1,0),np.coords_to_point(2,0),np.coords_to_point(2,6),color=YELLOW,fill_opacity=0.5)
        poly3 = Polygon(np.coords_to_point(2,6),np.coords_to_point(3,4),np.coords_to_point(3,0),np.coords_to_point(2,0),color=YELLOW,fill_opacity=0.5)
        areagroup = VGroup(poly1,poly2,poly3)
        p1l = MathTex(r"-1")
        p2l = MathTex(r"3")
        p3l = MathTex(r"5")
        p1l.move_to(poly1.get_center())
        p2l.move_to(poly2.get_center())
        p3l.move_to(poly3.get_center())
        labelgroup = VGroup(p1l,p2l,p3l)
        self.play(Create(box))
        self.wait(2)
        self.play(DrawBorderThenFill(areagroup))
        self.play(Write(labelgroup))
        explanation1p3 = MathTex(r"g(3)=2+",r"-1",r"+",r"3",r"+",r"5")
        explanation1p3.move_to(explanation1p2)
        ex3g1 = VGroup(explanation1p3[0],explanation1p3[2],explanation1p3[4])
        ex3g2 = VGroup(explanation1p3[1],explanation1p3[3],explanation1p3[5])
        self.play(Transform(explanation1p2,ex3g1))
        self.add(ex3g1)
        self.remove(explanation1p2)
        self.wait(0.5)
        ...
        self.remove(labelgroup)
        self.wait(0.5)
        explanation1p4 = MathTex(r"g(3)=9")
        explanation1p4.move_to(explanation1p3)
        self.play(Transform(explanation1p3,explanation1p4),Uncreate(box))
        self.wait(0.5)
        self.play(Transform(explanation1p3,question[1]))
        self.add(question[1])
        self.remove(explanation1p3)
...
class Big10FTC5(Scene):
    def construct(self):
        ...
        firstline = Line(np.coords_to_point(-2,-4),np.coords_to_point(0,4),color=BLUE)
        secondline = Line(np.coords_to_point(0,2),np.coords_to_point(2,0),color=BLUE)
        thirdline = Line(np.coords_to_point(2,-3),np.coords_to_point(4,1),color=BLUE)
        fourthline = Line(np.coords_to_point(4,1),np.coords_to_point(6,-5),color=BLUE)
        dot1 = Dot(point = np.coords_to_point(-2,-4),color=WHITE)
        dot2 = Dot(point = np.coords_to_point(0,4),color=WHITE)
        dot3 = Circle(color=WHITE, radius=0.08, fill_opacity=0)
        dot3.move_to(np.coords_to_point(0,2))
        dot4 = Dot(point = np.coords_to_point(2,0),color=WHITE)
        dot5 = Circle(color=WHITE, radius=0.08, fill_opacity=0)
        dot5.move_to(np.coords_to_point(2,-3))
        dot6 = Dot(point = np.coords_to_point(4,1),color=WHITE)
        dot7 = Dot(point = np.coords_to_point(6,-5),color=WHITE)
        graph = VGroup(firstline,secondline,thirdline,fourthline,dot1,dot2,dot3,dot4,dot5,dot6,dot7)
        label = MathTex(r"h(x)")
        label.move_to(np.coords_to_point(2,1))
        self.play(Create(np))
        self.play(Create(graph,run_time=3))
        self.play(Write(label))
        graphall = VGroup(graph,label,np)
        self.wait(2)
        graphtarget = graphall.copy()
        graphtarget.width=4
        graphtarget.to_corner(UL)
        self.play(Transform(graphall,graphtarget))
        self.wait(2)
        question = MathTex(r"Find~7-\int_{-2}^{0}\!h(x)~dx=",r"7")
        question.next_to(graphall,RIGHT)
        question.shift([2,0,0])
        self.play(Write(question[0]))
        self.wait(2)
        explanation1p1 = MathTex(r"\int_{-2}^{0}\!h(x)~dx")
        explanation1p1.next_to(question,DOWN)
        self.play(Write(explanation1p1))
        self.wait(0.5)
        box = SurroundingRectangle(explanation1p1,buff=0.1)
        tri1 = Polygon(np.coords_to_point(-2,-4),np.coords_to_point(-2,0),np.coords_to_point(-1,0),color=YELLOW,fill_opacity=0.5)
        tri2 = Polygon(np.coords_to_point(-1,0),np.coords_to_point(0,4),np.coords_to_point(0,0),color=YELLOW,fill_opacity=0.5)
        t1l = MathTex(r"-2")
        t2l = MathTex(r"2")
        t1l.move_to(tri1.get_center())
        t2l.move_to(tri2.get_center())
        areagroup = VGroup(tri1,tri2)
        labelgroup = VGroup(t1l,t2l)
        self.play(Create(box),DrawBorderThenFill(areagroup),Write(labelgroup))
        self.wait(2)
        explanation1p2 = MathTex(r"7-(",r"-2",r"+",r"2",r")")
        explanation1p2.move_to(explanation1p1)
        ex2g1 = VGroup(explanation1p2[0],explanation1p2[2],explanation1p2[4])
        ex2g2 = VGroup(explanation1p2[1],explanation1p2[3])
        self.play(Uncreate(box),LaggedStart(Transform(explanation1p1,ex2g1)))
        self.add(ex2g1)
        self.remove(explanation1p1)
        self.wait(0.5)
        self.play(Transform(labelgroup,ex2g2),Unwrite(areagroup))
        self.add(ex2g2)
        self.remove(labelgroup)
        self.wait(0.5)
        explanation1p3 = MathTex(r"7")
        explanation1p3.move_to(explanation1p2)
        self.play(Transform(explanation1p2,explanation1p3))
        self.add(explanation1p3)
        self.remove(explanation1p2)
        ...
        self.wait(2)
        self.play(Unwrite(question))
        question = MathTex(r"Find~\int_{0}^{2}\!h(x)+3~dx=",r"8")
        question.next_to(graphall,RIGHT)
        question.shift([2,0,0])
        self.play(Write(question[0]))
        self.wait(2)
        explanation2p1 = MathTex(r"\int_{0}^{2}\!h(x)+3~dx")
        explanation2p1.next_to(question,DOWN)
        explanation2p2 = MathTex(r"\int_{0}^{2}\!h(x)~dx",r"+6")
        explanation2p2.move_to(explanation2p1)
        self.play(Write(explanation2p1))
        self.wait(0.5)
        self.play(Transform(explanation2p1,explanation2p2))
        self.add(explanation2p2)
        self.remove(explanation2p1)
        box = SurroundingRectangle(explanation2p2[0])
        tri3 = Polygon(np.coords_to_point(0,0),np.coords_to_point(0,2),np.coords_to_point(2,0),color=YELLOW,fill_opacity=0.5)
        t3l = MathTex(r"2")
        t3l.move_to(tri3.get_center())
        self.play(Create(box))
        self.play(DrawBorderThenFill(tri3),Write(t3l))
        self.wait(2)
        explanation2p3 = MathTex(r"2",r"+ 6")
        explanation2p3.move_to(explanation2p2)
        self.play(Transform(explanation2p2,explanation2p3[1]),Uncreate(box),Unwrite(tri3))
        self.play(Transform(t3l,explanation2p3[0]))
        self.add(explanation2p3)
        self.remove(explanation2p2,t3l)
        self.wait(0.5)
        self.play(Transform(explanation2p3,question[1]))
        self.add(question[1])
        self.remove(explanation2p3)
        ...
        self.play(Uncreate(graph,run_time=2))
        self.play(Uncreate(np))
        self.wait(2)